...
const style = {
  ...
  default:
    "h-screen overflow-y-auto text-white top-0 lg:absolute bg-gradient-to-r from-purple-900 to-orange-600  lg:block lg:z-40 shadow-[rgba(0,0,15,0.5)_5px_72px_4px_0px]",
};
