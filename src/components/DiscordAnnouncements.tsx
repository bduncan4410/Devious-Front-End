...
export function DiscordAnnouncements(): JSX.Element {
  ...
  return (
    <div className="mt-8 w-full lg:mt-0 lg:w-4/12 lg:pl-4">
      <div className="rounded-lg bg-slate-900 bg-opacity-75 px-6 pt-6 mb-2">
        <div className="flex mx-auto pb-8 items-center">
          <ServerStats />
        </div>
      </div>
      <div className="rounded-lg bg-slate-900 bg-opacity-75 px-6 pt-6">
        <div className="flex pb-6 text-2xl font-bold text-white">
          <p>Discord Announcements</p>
        </div>
        <div className="py-6">
          {content}
        </div>
